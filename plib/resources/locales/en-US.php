...
$messages = [
    ...
    'setupDefaultInterval'              => 'Default interval (seconds)',
    ...
    'synchronizeUpdateMonitorDone'      => 'Monitor %%ur_id%% updated for domain %%domain%%', // domain, ur_id
    'synchronizeUpdateMonitorNOK'       => 'Unable to update monitor %%ur_id%% for domain %%domain%%. Output received: %%json%%', // domain, ur_id, json
    'synchronizeDeleteMonitorDone'      => 'Uptime Robot monitor %%ur_id%% deleted', // ur_id
    'synchronizeDeleteMonitorNOK'       => 'Unable to delete monitor %%ur_id%%. Output received: %%json%%', // ur_id, json
